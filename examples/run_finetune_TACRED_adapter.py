...
def load_and_cache_examples(args, task, tokenizer, dataset_type, evaluate=False):
    ...
    if evaluate:
        examples = processor.get_dev_examples(args.data_dir, dataset_type, args.negative_sample)
    elif not evaluate:
        examples = processor.get_train_examples(args.data_dir, dataset_type, args.negative_sample)
