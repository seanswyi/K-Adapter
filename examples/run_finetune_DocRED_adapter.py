...
from models import Adapter, AdapterModel, PretrainedModel
...
def main():
    ...
    parser.add_argument('--classifier', default='bilinear', type=str, choices=['linear', 'bilinear'])
    parser.add_argument('--at_loss', action='store_true', default=False)
    ...
    wandb_name = f'DocRED_{args.learning_rate}_{args.classifier}'
    wandb.init(project='K-Adapter', name=wandb_name)
