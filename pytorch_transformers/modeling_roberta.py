...
class RobertaForEntityTyping(BertPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        # torch.nn.init.constant_(self.dense.bias, 0)
...
class RobertaForTACRED(BertPreTrainedModel):
    ...
    def forward(self, input_ids, attention_mask=None, token_type_ids=None, position_ids=None, head_mask=None,
        ...
        # print('input:{}'.format(input_ids.size()))
        # batch = input_ids.size(0)
        ...
        # print('subj_output:{}'.format(subj_output.size()))
        # print('obj_output:{}'.format(obj_output.size()))
        # print('subj:{}'.format(subj_output.squeeze(1).size()))
        # print('obj:{}'.format(obj_output.squeeze(1).size()))
        # print(obj_output.squeeze().size())
        # print('cat:{}'.format(torch.cat((subj_output.squeeze(1), obj_output.squeeze(1)),dim=1).size()))
        # print('dense:{}'.format(self.dense(torch.cat((subj_output.squeeze(1), obj_output.squeeze(1)),dim=1)).size()))
